...
export default function Navbar(){
  ...
  <a href="/" className="flex items-center">
      ...
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">GrowwStonks</span>
  </a>
  <div className="flex md:order-2">
    ...
    <div className="relative hidden md:block">
      ...
      <div>
      <div id="dropdown-search-city " className={`z-10 ${suggestions.length ? '' : 'hidden'} bg-white divide-y divide-gray-100 rounded-lg shadow w-full dark:bg-gray-700 absolute mt-1 `}>
